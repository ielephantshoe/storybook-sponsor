...
export default function Appbar({ logo, children, ...props }) {
  return (
    <Box id='appbar-container' sx={{ display: 'grid', background: '#d7cec7', gridTemplateColumns: [ null,'1fr 1fr','1fr 1fr'], gridAutoColumns: '1fr', paddingBlock: 'min(2em, 1vh)', paddingInline: 'min(0.5em, 2vw)', gap: 'min(2em, 5vw)', boxShadow: '0 2px 4px -1px rgba(0,0,0,.2),0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12);' }}>
      {logo &&
