...
export default function SampleSponsorResources({ data }) {
    return (
        <Box>
            <Appbar logo={GCImage}>
            ...
            <Box sx={{ maxWidth: '1400px', marginInline: 'auto', marginBlock: '2em', padding: ['1em', '3em', '3em'], background:'white' }}>
                ...
                <Box id='asset-table' sx={{ paddingBlock: '1em', display: 'grid', gridAutoRows: '1fr', gridGap: '1em' }}>
                    ...
                    <Box id='asset-entry' sx={{
                        display: 'grid', border: '1px solid #f1f3f4', gridTemplateColumns: '66% 30%', gridAutoFlow: 'column', padding: '0.5em', gap: 'min(1em,1vw)', boxShadow: '0 0 0.5rem rgba(0, 0, 0, 0.1)', cursor: 'pointer',
                        ':hover': {
                        ...
                        <Box sx={{ display: 'grid', gridAutoFlow: 'column', textTransform: 'uppercase', fontSize: ['0.70em', null, '0.75em'], justifyContent: 'end' }}>
